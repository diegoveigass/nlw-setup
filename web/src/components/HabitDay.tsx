...
export function HabitDay({
  ...
  const formattedDay = dayjs(date).format('DD/MM')
  ...
  return (
    <Popover.Root>
      ...
      <Popover.Portal>
        <Popover.Content className="min-w-[320px] p-6 rounded-2xl flex flex-col bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-background">
